...
public class CommonParametersController {
    ...
    @GetMapping
    private ResponseEntity<CommonParametersResponseDTO> findCommonParameters(
        ...
        CommonParametersResponseDTO commonParametersResponseDTO = commonParametersService.findAll(commonParametersRequestDTO);
